...
import VolenterCard from "../../components/volenterCard/VolenterCard.js";
  ...
  render() {
    ...
    return (
      <div className="experience-main">
        ...
        <ul
          className="greeting-text-p subTitle about-me-desc participation-text"
          style={{ color: theme.secondaryText }}
        >
          {participations.descriptions.map((item, index) => (
            <li className="descPoints" key={index}>
              {item}
            </li>
          ))}
